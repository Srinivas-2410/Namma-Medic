...
export default function HomeScreen() {
  ...
  const makeEmergencyCall = async (contactType: 'emergency' | 'doctor') => {
    if (!userProfile) {
      Alert.alert(
        'No Contact Information',
        'Please set up your emergency contacts in the Profile tab first.',
        [
    ...
    const contact = contactType === 'emergency'
    ...
    if (!contact.phone) {
      Alert.alert(
        'No Phone Number',
        `Please add a phone number for your ${contactType === 'emergency' ? 'emergency contact' : 'doctor'} in the Profile tab.`,
        [
          { text: 'Cancel', style: 'cancel' },
          { text: 'Go to Profile', onPress: () => router.push('/profile') }
        ]
    ...
    Alert.alert(
      ...
      `Are you sure you want to call ${contact.name || (contactType === 'emergency' ? 'emergency contact' : 'doctor')} at +91 ${contact.phone}?`,
      [
        { text: 'Cancel', style: 'cancel' },
        {
          text: 'Call',
        ...
        <View style={styles.emergencyContainer}>
          ...
          <View style={styles.emergencyButtonsContainer}>
            <TouchableOpacity
              ...
              onPress={() => makeEmergencyCall('emergency')}
            >
              <LinearGradient
              ...
              >
                <View style={styles.emergencyContent}>
                  ...
                  <Text style={styles.emergencyLabel}>Emergency{'\n'}Contact</Text>
            ...
            <TouchableOpacity
              style={styles.emergencyButton}
              onPress={() => makeEmergencyCall('doctor')}
            >
              <LinearGradient
              ...
              >
                <View style={styles.emergencyContent}>
                  ...
                  <Text style={styles.emergencyLabel}>Primary{'\n'}Doctor</Text>
